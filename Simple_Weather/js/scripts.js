...
change_to_hourly_button.onclick = function() {
    ...
    var daily_weather_div = document.getElementById("dailyWeatherDiv");

    current_weather_div.style.display = "none";
    daily_weather_div.style.display = "none";
...
function changeDailyDate(section_number, time_element) {
    var date = new Date(parsed_weather_data.daily.data[section_number].time * 1000);
    var day = date.getDate();
    time_element.innerHTML = day;
};

var change_to_daily_button = document.getElementById("changeToDailyButton");
change_to_daily_button.onclick = function(){

    var hourly_weather_div = document.getElementById("hourlyWeatherDiv");
    hourly_weather_div.style.display = "none";
    var daily_weather_div = document.getElementById("dailyWeatherDiv");
    daily_weather_div.style.display = "block";
    var current_weather_div = document.getElementById("currentWeatherDiv");
    current_weather_div.style.display = "none";

    var html_day_sections = ["dailyFirstDaySection", "dailySecondDaySection", "dailyThirdDaySection", "dailyFourthDaySection", "dailyFifthDaySection", "dailySixthDaySection"];
    for (i=0; i < 6; i++) {
        changeDailyDate(i, document.getElementById(html_day_sections[i]));
    };

    var icon_size = "fa-3x";
    var html_icon_sections = ["dailyFirstIconSection", "dailySecondIconSection", "dailyThirdIconSection", "dailyFourthIconSection", "dailyFifthIconSection", "dailySixthIconSection"];
   for (i=0; i< 6; i++) {
       changeWeatherIcon(parsed_weather_data.daily.data[i].icon, document.getElementById(html_icon_sections[i]), icon_size);
   };
};

var change_to_current_button = document.getElementById("changeToCurrentButton");
change_to_current_button.onclick = function() {
    var hourly_weather_div = document.getElementById("hourlyWeatherDiv");
    hourly_weather_div.style.display = "none";
    var daily_weather_div = document.getElementById("dailyWeatherDiv");
    daily_weather_div.style.display = "none";
